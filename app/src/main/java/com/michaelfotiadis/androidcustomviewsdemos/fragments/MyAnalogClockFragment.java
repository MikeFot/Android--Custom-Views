...
public class MyAnalogClockFragment extends Fragment implements View.OnClickListener {
    ...
    private MyAnalogClock mClock;

    public static MyAnalogClockFragment newInstance(final int sectionNumber) {
        MyAnalogClockFragment fragment = new MyAnalogClockFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mClock = (MyAnalogClock) view.findViewById(R.id.analog_clock);
