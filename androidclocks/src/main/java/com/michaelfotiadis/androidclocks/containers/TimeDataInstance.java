...
public class TimeDataInstance {
	...
	public TimeDataInstance(final long timeStarted) {
		final Long currentTime = Calendar.getInstance().getTimeInMillis();
		mCalendarLogged = Calendar.getInstance();
		mTimeElapsed = (int) ((currentTime - timeStarted) / FACTOR_MSEC_TO_MINUTES);
	}

	public TimeDataInstance(final long timeLogged, final long timeElapsed) {
	...
	public TimeDataInstance(final int timeElapsed, final Calendar calendarLogged) {
