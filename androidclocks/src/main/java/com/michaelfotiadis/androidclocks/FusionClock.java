...
import com.michaelfotiadis.androidclocks.containers.ClockInstance;
...
public class FusionClock extends View implements Clock {
	...
	private ClockInstance mClockInstance = new ClockInstance();

	private long mStartTime= 0;

	public FusionClock(Context context) {
		super(context);
	}

	public FusionClock(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	private FusionClock(Context context, AttributeSet attrs,
						int defStyle) {
