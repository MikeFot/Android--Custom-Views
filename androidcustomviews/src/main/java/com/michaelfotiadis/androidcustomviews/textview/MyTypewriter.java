package com.michaelfotiadis.androidcustomviews.textview;
...
public class MyTypewriter extends TextView {
    ...
    public MyTypewriter(final Context context) {
        super(context);
    }

    public MyTypewriter(final Context context, AttributeSet attrs) {
        super(context, attrs);
    }
